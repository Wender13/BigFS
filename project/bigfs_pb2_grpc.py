...
class GatewayServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DownloadFile = channel.unary_stream(
                '/bigfs.GatewayService/DownloadFile',
                request_serializer=bigfs__pb2.FileRequest.SerializeToString,
                response_deserializer=bigfs__pb2.ChunkDownloadResponse.FromString,
                _registered_method=True)
        ...
        self.RemoveFile = channel.unary_unary(
                '/bigfs.GatewayService/RemoveFile',
                request_serializer=bigfs__pb2.FileRequest.SerializeToString,
                response_deserializer=bigfs__pb2.SimpleResponse.FromString,
                _registered_method=True)
...
class GatewayServiceServicer(object):
    ...
    def DownloadFile(self, request, context):
        """NOVO: Download via streaming (em vez de GetDownloadMap)
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_GatewayServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DownloadFile': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=bigfs__pb2.ChunkDownloadResponse.SerializeToString,
            ),
...
class GatewayService(object):
    ...
    def DownloadFile(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            bigfs__pb2.ChunkDownloadResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class MetadataServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListFiles = channel.unary_unary(
                ...
                _registered_method=True)
        self.RemoveFile = channel.unary_unary(
                '/bigfs.MetadataService/RemoveFile',
                request_serializer=bigfs__pb2.FileRequest.SerializeToString,
                response_deserializer=bigfs__pb2.RemoveFileResponse.FromString,
                _registered_method=True)
...
def add_MetadataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RemoveFile': grpc.unary_unary_rpc_method_handler(
                    servicer.RemoveFile,
                    request_deserializer=bigfs__pb2.FileRequest.FromString,
                    response_serializer=bigfs__pb2.RemoveFileResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class MetadataService(object):
    ...
    def RemoveFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/bigfs.MetadataService/RemoveFile',
            bigfs__pb2.FileRequest.SerializeToString,
            bigfs__pb2.RemoveFileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class StorageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RetrieveChunk = channel.unary_unary(
                ...
                _registered_method=True)
        self.RemoveChunk = channel.unary_unary(
                '/bigfs.StorageService/RemoveChunk',
                request_serializer=bigfs__pb2.ChunkRequest.SerializeToString,
                response_deserializer=bigfs__pb2.SimpleResponse.FromString,
                _registered_method=True)
...
def add_StorageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RemoveChunk': grpc.unary_unary_rpc_method_handler(
                    servicer.RemoveChunk,
                    request_deserializer=bigfs__pb2.ChunkRequest.FromString,
                    response_serializer=bigfs__pb2.SimpleResponse.SerializeToString,
            ),
    }
