...
class GatewayService(bigfs_pb2_grpc.GatewayServiceServicer):
    ...
    def DownloadFile(self, request, context):
        """
        NOVO: Gateway coordena todo o download e faz streaming para o cliente
        """
        try:
    ...
    def _fetch_chunk_with_fallback(self, location):
        """
        Gateway implementa fallback entre réplicas
        """
    ...
    def RemoveFile(self, request, context):
        """
        NOVO: Coordena a remoção de arquivo via Metadata Service
        """
        try:
